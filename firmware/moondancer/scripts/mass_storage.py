...
from diskimage import DiskImage, FAT32DiskImage, RawDiskImage
...
class USBMassStorageDevice(USBDevice):
    ...
    class _Configuration(USBConfiguration):
        ...
        class _Interface(USBInterface):
            ...
            class _OutEndpoint(USBEndpoint):
                ...
                #    print(f"TODO EP1_OUT handle_data_received({self}) {len(data)}")
    ...
    def connect(self):
        ...
        # open our disk image
        filename = "disk.img" # TODO
        self.disk_image = RawDiskImage(filename, 512, verbose=3)
