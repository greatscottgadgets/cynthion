...
#[doc = "Field `connect` reader - TODO amaranth_soc/csr/reg.py:471"]
pub type CONNECT_R = crate::BitReader;
#[doc = "Field `connect` writer - TODO amaranth_soc/csr/reg.py:471"]
...
#[doc = "Field `low_speed_only` reader - TODO amaranth_soc/csr/reg.py:471"]
pub type LOW_SPEED_ONLY_R = crate::BitReader;
#[doc = "Field `low_speed_only` writer - TODO amaranth_soc/csr/reg.py:471"]
pub type LOW_SPEED_ONLY_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `full_speed_only` reader - TODO amaranth_soc/csr/reg.py:471"]
pub type FULL_SPEED_ONLY_R = crate::BitReader;
#[doc = "Field `full_speed_only` writer - TODO amaranth_soc/csr/reg.py:471"]
