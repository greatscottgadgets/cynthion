...
.. code-block :: sh
    ...
    # TODO - try follow https://glasgow-embedded.org/latest/install.html
...
More information on Amaranth can be found in the `Amaranth Language & tool change documentation <https://amaranth-lang.org/docs/amaranth/>`__.
