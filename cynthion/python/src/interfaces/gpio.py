...
class GPIOPin(object):
    ...
    async def on_state(self, state, check_pin_direction=False, pollrate=0.1):
        """ Convenience function to pause execution until the given pin is set to the given state. """
        while True:
